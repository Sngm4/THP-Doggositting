...
ActiveRecord::Schema.define(version: 2022_05_05_144920) do
  ...
  create_table "join_tables", force: :cascade do |t|
    ...
    t.integer "dog_id"
    t.integer "stroll_id"
    t.index ["dog_id"], name: "index_join_tables_on_dog_id"
    t.index ["stroll_id"], name: "index_join_tables_on_stroll_id"
  end
